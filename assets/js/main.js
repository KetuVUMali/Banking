...
(function(module) {
    (function(global2, factory) {
        ...
        var version = "3.7.1",
            rhtmlSuffix = /HTML$/i,
            jQuery = function(selector3, context3) {
        ...
        (function() {
            var i, Expr, outermostContext, sortInput, hasDuplicate, push2 = pushNative,
                document3, documentElement2, documentIsHTML, rbuggyQSA, matches, expando2 = jQuery.expando,
                dirruns = 0,
                done = 0,
            ...
            function find(selector3, context3, results, seed) {
                var m, i2, elem, nid, match, groups, newSelector, newContext = context3 && context3.ownerDocument,
                    nodeType = context3 ? context3.nodeType : 9;
                results = results || [];
            ...
            Expr = jQuery.expr = {
                ...
                filter: {
                    ...
                    CHILD: function(type, what, _argument, first, last) {
                        ...
                        return first === 1 && last === 0 ? (
                            ...
                            var cache2, outerCache, node, nodeIndex, start, dir2 = simple !== forward ? "nextSibling" : "previousSibling",
                ...
                pseudos: {
                    ...
                    not: markFunction(function(selector3) {
                        var input = [],
                            results = [],
                            matcher = compile(selector3.replace(rtrimCSS, "$1"));
            ...
            function matcherFromTokens(tokens) {
                var checkContext, matcher, j, len = tokens.length,
                    ...
                    matchers = [function(elem, context3, xml) {
            ...
            function matcherFromGroupMatchers(elementMatchers, setMatchers) {
                var bySet = setMatchers.length > 0,
                    ...
                    superMatcher = function(seed, context3, xml, results, outermost) {
            ...
            function compile(selector3, match) {
                var i2, setMatchers = [],
                    elementMatchers = [],
                    cached = compilerCache[selector3 + " "];
                if (!cached) {
                    if (!match) {
            ...
            function select(selector3, context3, results, seed) {
                var i2, tokens, token, type, find2, compiled = typeof selector3 === "function" && selector3,
                    match = !seed && tokenize(selector3 = compiled.selector || selector3);
                results = results || [];
                if (match.length === 1) {
                ...
                (compiled || compile(selector3, match))(
                    seed,
                    context3, !documentIsHTML,
                    results, !context3 || rsibling.test(selector3) && testContext(context3.parentNode) || context3
                );
                return results;
            }
        ...
        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
            init5 = jQuery.fn.init = function(selector3, context3, root) {
                var match, elem;
                if (!selector3) {
                    return this;
                }
        ...
        function buildFragment(elems, context3, scripts, selection, ignored) {
            var elem, tmp, tag, wrap3, attached, j, fragment = context3.createDocumentFragment(),
                nodes = [],
                i = 0,
                l = elems.length;
            for (; i < l; i++) {
        ...
        function remove2(elem, selector3, keepData) {
            var node, nodes = selector3 ? jQuery.filter(selector3, elem) : elem,
                i = 0;
            for (;
                (node = nodes[i]) != null; i++) {
        ...
        function getWidthOrHeight(elem, dimension, extra) {
            var styles = getStyles(elem),
                boxSizingNeeded = !support2.boxSizingReliable() || extra,
            ...
            jQuery.cssHooks[dimension] = {
                ...
                set: function(elem, value, extra) {
                    var matches, styles = getStyles(elem),
                        scrollboxSizeBuggy = !support2.scrollboxSize() && styles.position === "absolute",
        ...
        function createTween(value, prop, animation) {
            var tween, collection = (Animation2.tweeners[prop] || []).concat(Animation2.tweeners["*"]),
                index = 0,
        ...
        function Animation2(elem, properties, options) {
            var result, stopped, index = 0,
                length = Animation2.prefilters.length,
        ...
        jQuery.fn.extend({
            ...
            toggleClass: function(value, stateVal) {
                var classNames, className, i, self2, type = typeof value,
        ...
        jQuery.extend({
            ...
            ajax: function(url, options) {
                ...
                options = options || {};
                var transport, cacheURL, responseHeadersString, responseHeaders, timeoutTimer, urlAnchor, completed2, fireGlobals, i, uncached, s = jQuery.ajaxSetup({}, options),
        ...
        jQuery.fn.load = function(url, params, callback) {
            var selector3, type, response, self2 = this,
                off = url.indexOf(" ");
            if (off > -1) {
...
var _config$1 = {
    ...
    _globalTimeline, _win$3, _coreInitted$3, _doc$3, _globals = {},
    _installScope = {},
...
var _gsap = {
    ...
    quickSetter: function quickSetter(target, property, unit) {
        ...
        var Plugin = _plugins[property],
            ...
            p = cache2.harness && (cache2.harness.aliases || {})[property] || property,
    ...
    quickTo: function quickTo(target, property, vars) {
        var _merge22;
        var tween = gsap$3.to(target, _merge((_merge22 = {}, _merge22[property] = "+=0.1", _merge22.paused = true, _merge22), vars || {})),
...
var CSSPlugin = {
    ...
    init: function init3(target, vars, tween, index, targets) {
        var props = this._props,
            ...
            startValue, endValue, endNum, startNum, type, specialProp, p, startUnit, endUnit, relative, isTransformRelated, transformPropTween, cache2, smooth, hasPriority, inlineProps;
        _pluginInitted || _initCore$2();
...
var Observer$1 = /* @__PURE__ */ function() {
    ...
    _proto.init = function init5(vars) {
        ...
        var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self2 = this,
            prevDeltaX = 0,
            prevDeltaY = 0,
            ...
            _onRelease = self2.onRelease = function(e) {
                ...
                var isTrackingDrag = !isNaN(self2.y - self2.startY),
                    ...
                    isDragNotClick = wasDragging && (Math.abs(self2.x - self2.startX) > 3 || Math.abs(self2.y - self2.startY) > 3),
    ...
    _proto.init = function init5(vars, animation) {
            ...
            snapDelayedCall = gsap.delayedCall(snap3.delay || scrubSmooth / 2 || 0.1, function() {
                ...
                if ((refreshedRecently || Math.abs(self2.getVelocity()) < 10) && !tween && !_pointerIsDown && lastSnap !== scroll) {
                    var progress = (scroll - start) / change,
                        ...
                        endValue, endScroll, _snap = snap3,
        ...
        self2.refresh = function(soft, force, position, pinOffset) {
            ...
            var size = getScrollerSize(),
                ...
                pinnedContainer = self2.pinnedContainer = vars.pinnedContainer && _getTarget(vars.pinnedContainer, self2),
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
    ...
    _nestedScroll = function _nestedScroll2(_ref5) {
        ...
        var node = (event.changedTouches ? event.changedTouches[0] : event).target,
            cache2 = node._gsap || gsap.core.getCache(node),
            time = _getTime(),
            cs;
    ...
    _getScrollNormalizer = function _getScrollNormalizer2(vars) {
        ...
        var _vars2 = vars,
            ...
            self2, maxY, target = _getTarget(vars.target) || _docEl,
            ...
            ignoreDrag = function ignoreDrag2() {
                if (skipTouchMove) {
                    ...
                    var offset = _round2(self2.deltaY / 2),
        ...
        vars.onChange = function(self3, dx, dy, xArray, yArray) {
            ...
            if (dy) {
                ...
                var isTouch = yArray[2] === dy,
                    y = isTouch ? startScrollY + self3.startY - self3.y : scrollFuncY() + dy - yArray[1],
